cmd_arch/x86/tools/insn_sanity := x86_64-pc-linux-gnu-gcc -Wp,-MMD,arch/x86/tools/.insn_sanity.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89     -I./tools/include -Wall -I./tools/arch/x86/lib/ -I./tools/arch/x86/include/ -I./arch/x86/lib/   -o arch/x86/tools/insn_sanity arch/x86/tools/insn_sanity.c   
