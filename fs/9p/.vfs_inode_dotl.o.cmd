...
deps_fs/9p/vfs_inode_dotl.o := \
  ...
  include/net/9p/9p.h \
    $(wildcard include/config/NET_9P_DEBUG) \
  ...
  fs/9p/v9fs.h \
    $(wildcard include/config/9P_FSCACHE) \
  ...
  fs/9p/xattr.h \
  fs/9p/acl.h \
    $(wildcard include/config/9P_FS_POSIX_ACL) \

fs/9p/vfs_inode_dotl.o: $(deps_fs/9p/vfs_inode_dotl.o)

$(deps_fs/9p/vfs_inode_dotl.o):

fs/9p/vfs_inode_dotl.o: $(wildcard ./tools/objtool/objtool)
