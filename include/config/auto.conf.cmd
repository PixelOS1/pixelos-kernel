...
ifneq "$(KERNELVERSION)" "5.17.1-pixelos"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "x86_64-pc-linux-gnu-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "x86_64-pc-linux-gnu-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "x86_64-pc-linux-gnu-gcc (Gentoo 11.2.1_p20220115 p4) 11.2.1 20220115"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "x86_64-pc-linux-gnu-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "x86_64-pc-linux-gnu-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "x86"
include/config/auto.conf: FORCE
endif
ifneq "$(AR)" "x86_64-pc-linux-gnu-ar"
include/config/auto.conf: FORCE
endif
ifneq "$(PAHOLE)" "pahole"
include/config/auto.conf: FORCE
