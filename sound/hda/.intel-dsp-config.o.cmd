...
deps_sound/hda/intel-dsp-config.o := \
    ...
    $(wildcard include/config/SND_SOC_SOF_GEMINILAKE) \
    $(wildcard include/config/SND_SOC_SOF_CANNONLAKE) \
    $(wildcard include/config/SND_SOC_SOF_COFFEELAKE) \
    $(wildcard include/config/SND_SOC_SOF_COMETLAKE) \
    $(wildcard include/config/SND_SOC_SOF_ICELAKE) \
    $(wildcard include/config/SND_SOC_SOF_JASPERLAKE) \
    $(wildcard include/config/SND_SOC_SOF_TIGERLAKE) \
    $(wildcard include/config/SND_SOC_SOF_ELKHARTLAKE) \
    $(wildcard include/config/SND_SOC_SOF_ALDERLAKE) \
    $(wildcard include/config/SND_SOC_SOF_INTEL_SOUNDWIRE) \
    $(wildcard include/config/SND_INTEL_BYT_PREFER_SOF) \
    $(wildcard include/config/SND_SST_ATOM_HIFI2_PLATFORM_ACPI) \
    $(wildcard include/config/SND_SOC_SOF_BAYTRAIL) \
    $(wildcard include/config/SND_SOC_INTEL_CATPT) \
    $(wildcard include/config/SND_SOC_SOF_BROADWELL) \
...
sound/hda/intel-dsp-config.o: $(wildcard ./tools/objtool/objtool)
