...
MODULE_INFO(depends, "snd-soc-core,snd-soc-intel-hda-dsp-common,snd-pcm,snd-soc-da7219,snd,snd-soc-hdac-hdmi");
...
MODULE_INFO(srcversion, "E40EFEF513FC76EDC3EFC3C");
