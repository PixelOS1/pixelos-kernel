...
MODULE_INFO(depends, "snd-soc-core,snd-soc-rt298,snd-soc-intel-hda-dsp-common,snd-pcm,snd-soc-hdac-hdmi");

MODULE_ALIAS("platform:bxt_alc298s_i2s");
MODULE_ALIAS("platform:glk_alc298s_i2s");

MODULE_INFO(srcversion, "FE8A451EC0E4C7AB7EBC373");
