...
__used __section("__versions") = {
	...
	{ 0xa627772, "ts3a227e_enable_jack_detect" },
	{ 0x416d3e65, "__platform_driver_register" },
	{ 0xe2d5255a, "strcmp" },
	{ 0x5a921311, "strncmp" },
	{ 0x8af62e49, "_dev_err" },
	{ 0xf8db5365, "devm_acpi_dev_add_driver_gpios" },
	{ 0xee928f30, "snd_soc_jack_notifier_register" },
	...
	{ 0xde050c13, "snd_soc_jack_add_gpiods" },
};

MODULE_INFO(depends, "snd-soc-core,snd-soc-ts3a227e,snd-pcm");


MODULE_INFO(srcversion, "DE89C08F54F278A2E3E005B");
