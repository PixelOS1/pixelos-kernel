cmd_lib/zstd/compress/zstd_compress_superblock.o := x86_64-pc-linux-gnu-gcc -Wp,-MMD,lib/zstd/compress/.zstd_compress_superblock.o.d -nostdinc -I./arch/x86/include -I./arch/x86/include/generated  -I./include -I./arch/x86/include/uapi -I./arch/x86/include/generated/uapi -I./include/uapi -I./include/generated/uapi -include ./include/linux/compiler-version.h -include ./include/linux/kconfig.h -include ./include/linux/compiler_types.h -D__KERNEL__ -fmacro-prefix-map=./= -Wall -Wundef -Werror=strict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -fshort-wchar -fno-PIE -Werror=implicit-function-declaration -Werror=implicit-int -Werror=return-type -Wno-format-security -std=gnu89 -mno-sse -mno-mmx -mno-sse2 -mno-3dnow -mno-avx -fcf-protection=none -m64 -falign-jumps=1 -falign-loops=1 -mno-80387 -mno-fp-ret-in-387 -mpreferred-stack-boundary=3 -mskip-rax-setup -mtune=generic -mno-red-zone -mcmodel=kernel -DCONFIG_X86_X32_ABI -Wno-sign-compare -fno-asynchronous-unwind-tables -mindirect-branch=thunk-extern -mindirect-branch-register -fno-jump-tables -fno-delete-null-pointer-checks -Wno-frame-address -Wno-format-truncation -Wno-format-overflow -Wno-address-of-packed-member -O3 -fno-allow-store-data-races -Wframe-larger-than=2048 -fstack-protector-strong -Wimplicit-fallthrough=5 -Wno-main -Wno-unused-but-set-variable -Wno-unused-const-variable -fno-stack-clash-protection -pg -mrecord-mcount -mfentry -DCC_USING_FENTRY -Wdeclaration-after-statement -Wvla -Wno-pointer-sign -Wcast-function-type -Wno-stringop-truncation -Wno-zero-length-bounds -Wno-array-bounds -Wno-stringop-overflow -Wno-restrict -Wno-maybe-uninitialized -Wno-alloc-size-larger-than -fno-strict-overflow -fno-stack-check -fconserve-stack -Werror=date-time -Werror=incompatible-pointer-types -Werror=designated-init -Wno-packed-not-aligned    -DKBUILD_MODFILE='"lib/zstd/zstd_compress"' -DKBUILD_BASENAME='"zstd_compress_superblock"' -DKBUILD_MODNAME='"zstd_compress"' -D__KBUILD_MODNAME=kmod_zstd_compress -c -o lib/zstd/compress/zstd_compress_superblock.o lib/zstd/compress/zstd_compress_superblock.c  ; ./tools/objtool/objtool orc generate   --no-fp   --retpoline  --uaccess   lib/zstd/compress/zstd_compress_superblock.o

source_lib/zstd/compress/zstd_compress_superblock.o := lib/zstd/compress/zstd_compress_superblock.c

deps_lib/zstd/compress/zstd_compress_superblock.o := \
...
lib/zstd/compress/zstd_compress_superblock.o: $(deps_lib/zstd/compress/zstd_compress_superblock.o)

$(deps_lib/zstd/compress/zstd_compress_superblock.o):

lib/zstd/compress/zstd_compress_superblock.o: $(wildcard ./tools/objtool/objtool)
