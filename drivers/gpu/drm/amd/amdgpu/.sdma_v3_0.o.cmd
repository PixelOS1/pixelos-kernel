...
deps_drivers/gpu/drm/amd/amdgpu/sdma_v3_0.o := \
  ...
  drivers/gpu/drm/amd/amdgpu/amdgpu.h \
    $(wildcard include/config/HSA_AMD) \
    $(wildcard include/config/DRM_AMDGPU_SI) \
    $(wildcard include/config/DRM_AMDGPU_CIK) \
    $(wildcard include/config/DRM_AMD_ACP) \
    $(wildcard include/config/VGA_SWITCHEROO) \
    $(wildcard include/config/ACPI) \
    $(wildcard include/config/SUSPEND) \
    $(wildcard include/config/DRM_AMD_DC) \
  ...
  include/drm/drm_dp_mst_helper.h \
    $(wildcard include/config/DRM_DEBUG_DP_MST_TOPOLOGY_REFS) \
  ...
  drivers/gpu/drm/amd/amdgpu/amdgpu_ttm.h \
    $(wildcard include/config/DRM_AMDGPU_USERPTR) \
  ...
  drivers/gpu/drm/amd/amdgpu/../include/asic_reg/gca/gfx_8_0_enum.h \
    $(wildcard include/config/SPACE_START) \
    $(wildcard include/config/SPACE_END) \
    $(wildcard include/config/SPACE1_START) \
    $(wildcard include/config/SPACE1_END) \
    $(wildcard include/config/SPACE2_START) \
    $(wildcard include/config/SPACE2_END) \
    $(wildcard include/config/1_PIPE) \
    $(wildcard include/config/2_PIPE) \
    $(wildcard include/config/4_PIPE) \
    $(wildcard include/config/8_PIPE) \
    $(wildcard include/config/4_BANK) \
    $(wildcard include/config/8_BANK) \
    $(wildcard include/config/256B_GROUP) \
    $(wildcard include/config/512B_GROUP) \
    $(wildcard include/config/1KB_ROW) \
    $(wildcard include/config/2KB_ROW) \
    $(wildcard include/config/4KB_ROW) \
    $(wildcard include/config/8KB_ROW) \
    $(wildcard include/config/1KB_ROW_OPT) \
    $(wildcard include/config/2KB_ROW_OPT) \
    $(wildcard include/config/4KB_ROW_OPT) \
    $(wildcard include/config/8KB_ROW_OPT) \
    $(wildcard include/config/128B_SWAPS) \
    $(wildcard include/config/256B_SWAPS) \
    $(wildcard include/config/512B_SWAPS) \
    $(wildcard include/config/1KB_SWAPS) \
    $(wildcard include/config/1KB_SPLIT) \
    $(wildcard include/config/2KB_SPLIT) \
    $(wildcard include/config/4KB_SPLIT) \
    $(wildcard include/config/8KB_SPLIT) \
  ...
  drivers/gpu/drm/amd/amdgpu/../include/asic_reg/bif/bif_5_0_sh_mask.h \
    $(wildcard include/config/CNTL__CFG_VGA_RAM_EN_MASK) \
    $(wildcard include/config/CNTL__CFG_VGA_RAM_EN__SHIFT) \
    $(wildcard include/config/CNTL__VGA_DIS_MASK) \
    $(wildcard include/config/CNTL__VGA_DIS__SHIFT) \
    $(wildcard include/config/CNTL__GENMO_MONO_ADDRESS_B_MASK) \
    $(wildcard include/config/CNTL__GENMO_MONO_ADDRESS_B__SHIFT) \
    $(wildcard include/config/CNTL__GRPH_ADRSEL_MASK) \
    $(wildcard include/config/CNTL__GRPH_ADRSEL__SHIFT) \
    $(wildcard include/config/MEMSIZE__CONFIG_MEMSIZE_MASK) \
    $(wildcard include/config/MEMSIZE__CONFIG_MEMSIZE__SHIFT) \
    $(wildcard include/config/RESERVED__CONFIG_RESERVED_MASK) \
    $(wildcard include/config/RESERVED__CONFIG_RESERVED__SHIFT) \
    $(wildcard include/config/F0_BASE__F0_BASE_MASK) \
    $(wildcard include/config/F0_BASE__F0_BASE__SHIFT) \
    $(wildcard include/config/APER_SIZE__APER_SIZE_MASK) \
    $(wildcard include/config/APER_SIZE__APER_SIZE__SHIFT) \
    $(wildcard include/config/REG_APER_SIZE__REG_APER_SIZE_MASK) \
    $(wildcard include/config/REG_APER_SIZE__REG_APER_SIZE__SHIFT) \
...
drivers/gpu/drm/amd/amdgpu/sdma_v3_0.o: $(wildcard ./tools/objtool/objtool)
