...
deps_drivers/gpu/drm/amd/amdgpu/iceland_ih.o := \
  ...
  drivers/gpu/drm/amd/amdgpu/../include/asic_reg/bif/bif_5_1_sh_mask.h \
    ...
    $(wildcard include/config/CNTL_IND__CFG_VGA_RAM_EN_MASK) \
    $(wildcard include/config/CNTL_IND__CFG_VGA_RAM_EN__SHIFT) \
    $(wildcard include/config/CNTL_IND__VGA_DIS_MASK) \
    $(wildcard include/config/CNTL_IND__VGA_DIS__SHIFT) \
    $(wildcard include/config/CNTL_IND__GENMO_MONO_ADDRESS_B_MASK) \
    $(wildcard include/config/CNTL_IND__GENMO_MONO_ADDRESS_B__SHIFT) \
    $(wildcard include/config/CNTL_IND__GRPH_ADRSEL_MASK) \
    $(wildcard include/config/CNTL_IND__GRPH_ADRSEL__SHIFT) \
    $(wildcard include/config/MEMSIZE_IND__CONFIG_MEMSIZE_MASK) \
    $(wildcard include/config/MEMSIZE_IND__CONFIG_MEMSIZE__SHIFT) \
    $(wildcard include/config/F0_BASE_IND__F0_BASE_MASK) \
    $(wildcard include/config/F0_BASE_IND__F0_BASE__SHIFT) \
    $(wildcard include/config/APER_SIZE_IND__APER_SIZE_MASK) \
    $(wildcard include/config/APER_SIZE_IND__APER_SIZE__SHIFT) \
    $(wildcard include/config/REG_APER_SIZE_IND__REG_APER_SIZE_MASK) \
    $(wildcard include/config/REG_APER_SIZE_IND__REG_APER_SIZE__SHIFT) \

drivers/gpu/drm/amd/amdgpu/iceland_ih.o: $(deps_drivers/gpu/drm/amd/amdgpu/iceland_ih.o)

$(deps_drivers/gpu/drm/amd/amdgpu/iceland_ih.o):

drivers/gpu/drm/amd/amdgpu/iceland_ih.o: $(wildcard ./tools/objtool/objtool)
