...
__used __section("__versions") = {
	...
	{ 0x4c01b9ea, "usb_wwan_dtr_rts" },
	{ 0x531af1ed, "usb_wwan_tiocmset" },
	{ 0x96d98b6a, "usb_wwan_tiocmget" },
	{ 0x26124f5, "usb_wwan_chars_in_buffer" },
	{ 0x35a5c3f, "usb_wwan_write_room" },
	{ 0x7a3a70d5, "usb_wwan_write" },
	{ 0xcdcd4655, "usb_wwan_close" },
	{ 0xfa25e7b3, "usb_wwan_open" },
	{ 0x922dc6e6, "usb_wwan_resume" },
	{ 0x9a2e2020, "usb_wwan_suspend" },
	{ 0x30d3314f, "usb_wwan_port_remove" },
	{ 0x51a0d989, "usb_wwan_port_probe" },
...
MODULE_INFO(srcversion, "29748B432748A55E4B60198");
