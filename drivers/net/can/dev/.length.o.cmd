...
drivers/net/can/dev/length.o: $(deps_drivers/net/can/dev/length.o)

$(deps_drivers/net/can/dev/length.o):

drivers/net/can/dev/length.o: $(wildcard ./tools/objtool/objtool)
