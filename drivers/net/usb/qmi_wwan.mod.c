...
MODULE_ALIAS("usb:v19D2p1485d*dc*dsc*dp*ic*isc*ip*in05*");
...
MODULE_ALIAS("usb:v22DEp9051d*dc*dsc*dp*ic*isc*ip*in02*");
...
MODULE_INFO(srcversion, "28BDE368666FDE440C292E6");
