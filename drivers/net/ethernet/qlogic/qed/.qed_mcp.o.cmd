...
deps_drivers/net/ethernet/qlogic/qed/qed_mcp.o := \
    $(wildcard include/config/QEDE_BITMAP_IDX) \
    $(wildcard include/config/QED_SRIOV_BITMAP_IDX) \
    $(wildcard include/config/QEDR_BITMAP_IDX) \
    $(wildcard include/config/QEDF_BITMAP_IDX) \
    $(wildcard include/config/QEDI_BITMAP_IDX) \
    $(wildcard include/config/QED_LL2_BITMAP_IDX) \
    $(wildcard include/config/QEDE) \
    $(wildcard include/config/QED_SRIOV) \
    $(wildcard include/config/QED_RDMA) \
    $(wildcard include/config/QED_FCOE) \
    $(wildcard include/config/QED_ISCSI) \
    $(wildcard include/config/QED_LL2) \
...
drivers/net/ethernet/qlogic/qed/qed_mcp.o: $(wildcard ./tools/objtool/objtool)
